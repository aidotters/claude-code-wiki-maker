...
| **D7** | anti-duplication（Notion-DB discovery は新規 mode でなく **mode I 拡張**・`feed_registry[]` 経路・4 系統目 plist / lint #17 / 4 つ目 pending array は作らない） | 4 | Phase 4 steering ／ SKILL I-3 |
