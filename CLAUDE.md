...
> **ステータス: MVP（Phase 1）＋ Phase 2a・2b・3a・3b・3d・3c・3e 実装済み**
...
> `.llm-wiki-inbox.jsonl` に貯めた URL を drain → opt-in 個別承認 → 共通 surface ingest・対話専用）と
...
> 追加＋ URL 正規化フル仕様を mode B step 3.5 単一正本化）を `.claude/skills/llm-wiki/` に実装済みです。
